...
export default function WeatherWidget({ navbarVisible }) {
  ...
  const topOffset = navbarVisible ? "top-[5.5rem]" : "top-4";

  return (
    <div
      className={`fixed ${topOffset} right-4 z-10 w-80 h-80 rounded-2xl overflow-hidden shadow-lg border border-white/25 transition-all duration-300`}
    >
